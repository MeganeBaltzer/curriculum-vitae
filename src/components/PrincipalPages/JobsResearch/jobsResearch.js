...
const JobsResearch = () => (
  <div className="jobsResearchContainer">
    <section>
      ...
      <p className="jobsResearchText"><strong>Actuellement en recherche d'emploi</strong>, je suis intéressée par toutes propositions qui conviennent à mon profil (CDI, CDD ou stage). Dans l'idéal, j'aimerais commencer par <strong>un stage de 6 mois ou 1 an</strong> afin de développer sereinement mes compétences dans le monde professionnel. En effet, étant donné que je ne subis pas de quelconque pression pour retrouver un emploi de façon urgente, je pense qu'un stage serait plus confortable pour mon évolution.</p>
    </section>

...
const JobsResearch = () => (
  <div className="jobsResearchContainer">
    <section>
      <p><strong>Actuellement en recherche d'emploi</strong>, je suis intéressée par toutes propositions qui conviennent à mon profil (CDI, CDD ou stage). Dans l'idéal, j'aimerais commencer par <strong>un stage de 6 mois ou 1 an</strong> afin de développer sereinement mes compétences dans le monde professionnel. Etant donné que je ne subis pas de quelconque pression pour retrouver un emploi de façon urgente, je pense qu'il serait plus confortable pour mon évolution de commencer par un stage.</p>
      ...
      <p>Intégrer une entreprise représente pour moi un réel enjeu pour mon avenir et j’espère réellement que mon profil retiendra toute votre attention. Je reste à votre disposition pour toute information complémentaire et je suis à votre disposition pour un prochain entretien.</p>
      <p>Veuillez agréer, Madame, Monsieur, mes respectueuses salutations.</p>
      <strong>Mégane Baltzer</strong>
    </section>

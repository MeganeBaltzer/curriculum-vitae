...
const Home = () => (
  <Row className="homeContainer">
    <Col xs={12} md lg={8} className="homeText">
      ...
      <p className="presentation mb-3">A l'âge de 31 ans, je vis à Noisy-le-Grand, en région parisienne. Je vis en concubinage avec mon conjoint et depuis 2021, nous avons une petite fille.</p>
      <p className="presentation mt-3">Actuellement, je bénéficie de 8 ans d'expérience professionnelle dans le domaine du journalisme, de la communication, du webmarketing et des relations presse. Cette expertise me permet d'avoir des compétences mais également de maîtriser des outils (Google Analytics, SemRush, etc) nécessaires dans de nombreux domaines.</p>
      <p>En effet, mes 5 années en tant que journaliste m'ont permis de développer une aisance rédactionnelle et orale. Mon métier en tant que responsable communication et webmarketing a favorisé une approche plus commerciale  de mes compétences, en transformant l'audience médiatique en chiffre d'affaires. Pour y parvenir, j'ai travaillé sur plusieurs réseaux sociaux (Facebook Instagram, Linkedin, Pinterest ou encore les blogs) et des supports commerciaux tels que les newsletters. Ces deux expériences professionnelles ont également exigé des connaissances en matière de SEO afin de maximiser la visibilité des contenus.</p>
      <p>Depuis 2018, j'ai créé mon entreprise afin de proposer mes services en tant que rédactrice mais également en tant qu'attachée de presse. En 2 ans d'activité, j'ai eu l'occasion de travailler pour deux entreprises. Ce statut d'auto-entrepreneur a favorisé une prise d'autonomie inévitable et très profitable pour l'ensemble de mes missions professionnelles.</p>
    </Col>
    <Col xs={12} mg lg={4} className="homeImage" style={{ display: 'flex', flexDirection: 'column', alignItems: 'center' }}>
      ...
      >
        <Card.Body>
          ...
          <div
            style={{
              display: 'flex', justifyContent: 'center', marginTop: '2em', backgroundColor: '#e1d8cf', color: '#373741', borderRadius: '1em',
            }}
          >
      ...
      <Image style={{ marginBottom: '2em' }} src={MegAnim} fluid />
    </Col>
  </Row>
);
